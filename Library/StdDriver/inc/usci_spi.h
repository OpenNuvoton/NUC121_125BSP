 ...
 * @file     usci_spi.h
 * @version  V3.00
 * @brief    NUC121 series USPI (USCI-SPI) driver header file
 *
...
/** @addtogroup USPI_EXPORTED_CONSTANTS USPI Exported Constants
  @{
*/
...
/**
  * @brief Get the USCI_SPI wake-up flag.
  * @param[in] uspi The pointer of the specified USCI_SPI module.
...
/**
  ...
  * \hideinitializer
  */
#define USPI_ENABLE_PDMA(uspi) ((uspi)->PDMACTL |= (USPI_PDMACTL_TXPDMAEN_Msk | USPI_PDMACTL_RXPDMAEN_Msk | USPI_PDMACTL_PDMAEN_Msk))
...
/**
  ...
  * \hideinitializer
  */
#define USPI_DISABLE_PDMA(uspi) ((uspi)->PDMACTL &= ~(USPI_PDMACTL_TXPDMAEN_Msk | USPI_PDMACTL_RXPDMAEN_Msk | USPI_PDMACTL_PDMAEN_Msk))
