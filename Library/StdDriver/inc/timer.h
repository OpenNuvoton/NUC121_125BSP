 ...
 * @file     timer.h
 * @version  V3.00
 * @brief    NUC121 series Timer driver header file
 *
...
#define TIMER_TRGSRC_TIMEOUT_EVENT      (0UL << TIMER_CTL_TRGSSEL_Pos)      /*!< Trigger source from Timeout event */
#define TIMER_TRGSRC_CAPTURE_EVENT      (1UL << TIMER_CTL_TRGSSEL_Pos)      /*!< Trigger source from Capture event */
