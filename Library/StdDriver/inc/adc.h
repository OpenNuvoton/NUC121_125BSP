...
#define ADC_ADCR_DIFFEN_DIFFERENTIAL    (1UL<<ADC_ADCR_DIFFEN_Pos)   /*!< Differential input mode    */
...
#define ADC_ADCR_TRGEN_DISABLE          (0UL<<ADC_ADCR_TRGEN_Pos)    /*!< Disable triggering of A/D conversion by external STADC pin, Timer or PWM   */
#define ADC_ADCR_TRGEN_ENABLE           (1UL<<ADC_ADCR_TRGEN_Pos)    /*!< Enable triggering of A/D conversion by external STADC pin, Timer or PWM  */
...
#define ADC_ADCR_SMPTSEL_2_CLOCK        (0UL<<ADC_ADCR_SMPTSEL_Pos)  /*!< A/D conversion sampling time is 2 ADC peripheral clock cycles */
#define ADC_ADCR_SMPTSEL_3_CLOCK        (1UL<<ADC_ADCR_SMPTSEL_Pos)  /*!< A/D conversion sampling time is 3 ADC peripheral clock cycles */
#define ADC_ADCR_SMPTSEL_4_CLOCK        (2UL<<ADC_ADCR_SMPTSEL_Pos)  /*!< A/D conversion sampling time is 4 ADC peripheral clock cycles */
#define ADC_ADCR_SMPTSEL_5_CLOCK        (3UL<<ADC_ADCR_SMPTSEL_Pos)  /*!< A/D conversion sampling time is 5 ADC peripheral clock cycles */
#define ADC_ADCR_SMPTSEL_6_CLOCK        (4UL<<ADC_ADCR_SMPTSEL_Pos)  /*!< A/D conversion sampling time is 6 ADC peripheral clock cycles */
#define ADC_ADCR_SMPTSEL_7_CLOCK        (5UL<<ADC_ADCR_SMPTSEL_Pos)  /*!< A/D conversion sampling time is 7 ADC peripheral clock cycles */
#define ADC_ADCR_SMPTSEL_8_CLOCK        (6UL<<ADC_ADCR_SMPTSEL_Pos)  /*!< A/D conversion sampling time is 8 ADC peripheral clock cycles */
#define ADC_ADCR_SMPTSEL_9_CLOCK        (7UL<<ADC_ADCR_SMPTSEL_Pos)  /*!< A/D conversion sampling time is 9 ADC peripheral clock cycles */

/*---------------------------------------------------------------------------------------------------------*/
/* ADCHER Constant Definitions                                                                             */
/*---------------------------------------------------------------------------------------------------------*/
#define ADC_ADCHER_BANDGAP              (1UL<<29)   /*!< The input source of channel 29 is the internal bandgap voltage     */
#define ADC_ADCHER_TEMPERATURE_SENSOR   (1UL<<30)   /*!< The input source of channel 30 is the internal temperature sensor  */
...
/**
  ...
  * @param[in] u32ChNum ADC Channel, valid value are from 0 to 11, 29 for bandgap, and 30 for temperature sensor.
  * @return  16-bit data.
...
/**
  ...
  * @param[in] adc The pointer of the specified ADC module.
  * @param[in] u32ChNum  Specifies the source channel, valid value are from 0 to 11, 29 for bandgap, and 30 for temperature sensor.
...
/**
  ...
  *       the current conversion and save the result to the ADDRx register of the enabled channel.
  * \hideinitializer
  */
