 ...
 * @file     usbd.h
 * @version  V3.00
 * @brief    NUC121 series USBD driver header file
 *
...
typedef struct s_usbd_info
{
    ...
    const uint8_t *gu8BosDesc;            /*!< Pointer for BOS Descriptor start index     */
} S_USBD_INFO_T;
...
#define USBD_INT_WAKEUP_IDLE    USBD_INTEN_NEVWKIEN_Msk     /*!< USB No-Event-Wake-Up Interrupt */
#define USBD_INT_SOFIEN         USBD_INTEN_SOFIEN_Msk       /*!< USB Start of Frame Interrput Enable Bit*/
...
#define USBD_4SOF_1INT          (2ul << USBD_ATTR_SOFITH_Pos) /*!<every   4SOF trigger one SOF interrupt*/
#define USBD_8SOF_1INT          (3ul << USBD_ATTR_SOFITH_Pos) /*!<every   8SOF trigger one SOF interrupt*/
#define USBD_16SOF_1INT         (4ul << USBD_ATTR_SOFITH_Pos) /*!<every  16SOF trigger one SOF interrupt*/
#define USBD_32SOF_1INT         (5ul << USBD_ATTR_SOFITH_Pos) /*!<every  32SOF trigger one SOF interrupt*/
#define USBD_64SOF_1INT         (6ul << USBD_ATTR_SOFITH_Pos) /*!<every  64SOF trigger one SOF interrupt*/
#define USBD_128SOF_1INT        (7ul << USBD_ATTR_SOFITH_Pos) /*!<every 128SOF trigger one SOF interrupt*/
...
/**
  ...
  *
  * @param[in]  ep The USB endpoint ID. NUC121 Series supports 8 hardware endpoint ID. This parameter could be 0 ~ 7.
  *
  * @return     None
  *
...
/**
  ...
  *
  * @param[in]  ep The USB endpoint ID. NUC121 Series supports 8 endpoint ID. This parameter could be 0 ~ 7.
  *
