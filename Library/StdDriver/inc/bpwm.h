 ...
 * @file     bpwm.h
 * @version  V3.00
 * @brief    NUC121 series BPWM driver header file
 *
 ...
 * @details This macro is used to enable timer synchronous mode of specified channel(s). All channels share the same setting.
 * \hideinitializer
 */
...
* \hideinitializer
*/
#define BPWM_GET_PRESCALER(bpwm, u32ChannelNum) (*(__IO uint32_t *) (&((bpwm)->CLKPSC)))
