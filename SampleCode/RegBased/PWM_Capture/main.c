...
void CalPeriodTime()
{
    ...
    while (u32i < 4)
    {
        ...
        u16Count[u32i++] = PWM_GET_CAPTURE_RISING_DATA(PWM1, 2);
    }
...
int32_t main(void)
{
    ...
    while (1)
    {
        ...
        */
        ...
        PWM_SET_OUTPUT_LEVEL(PWM1, PWM_CH_0_MASK, PWM_OUTPUT_HIGH, PWM_OUTPUT_LOW, PWM_OUTPUT_NOTHING, PWM_OUTPUT_NOTHING);
