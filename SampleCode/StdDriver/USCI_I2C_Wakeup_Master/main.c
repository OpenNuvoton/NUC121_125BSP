 ...
 * @file     main.c
 * @version  V3.00
 * @brief    Show how to wake up I2C slave from Power-down mode.
 *           This sample code needs to work with USCI_I2C_Wakeup_Slave.
 *
...
int main()
{
    ...
    */
    ...
    printf("+--------------------------------------------------------+\n");
    printf("| USCI_I2C Driver Sample Code (Slave) for wake-up        |\n");
    printf("| & access Slave test. This sample code needs work with  |\n");
    printf("|  USCI_I2C_Wakeup Slave sample code                     |\n");
