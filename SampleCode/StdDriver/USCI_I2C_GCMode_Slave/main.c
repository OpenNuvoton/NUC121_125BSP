 ...
 * @file     main.c
 * @version  V3.00
 * @brief    Show a Slave how to receive data
...
void UI2C0_Init(uint32_t u32ClkSpeed)
{
    ...
    UI2C_SetSlaveAddr(UI2C0, 0, 0x15, UI2C_GCMODE_ENABLE);   /* Slave Address : 0x15 */
    UI2C_SetSlaveAddr(UI2C0, 1, 0x35, UI2C_GCMODE_ENABLE);   /* Slave Address : 0x35 */
...
int main()
{
    ...
    */
    ...
    printf("|  address Slave(GC Mode). This sample code needs        |\n");
