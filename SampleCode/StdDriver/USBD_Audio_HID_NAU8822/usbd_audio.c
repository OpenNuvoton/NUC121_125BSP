...
volatile uint8_t g_u32EP4Ready = 0;
...
/**
 * @brief       EP4 Handler (HID IN interrupt handler)
 *
 * @param[in]   None
 *
 * @return      None
 *
 * @details     This function is used to process EP4 event (HID IN interrupt) for HID keyboard.
 */
...
void UAC_Init(void)
{
    ...
    /*****************************************************/
    /* EP4 ==> Interrupt IN endpoint number 3 */
