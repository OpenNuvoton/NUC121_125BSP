...
void SYS_Init(void)
{
    ...
    /* Set PC multi-function pins for BPWM0 Channel0~5 */
    ...
    /* Set PC multi-function pins for BPWM1 Channel0~5 */
...
int32_t main(void)
{
    ...
    BPWM_ConfigOutputChannel(BPWM1, 0, 60000, 10);
    BPWM_ConfigOutputChannel(BPWM1, 1, 60000, 20);
    BPWM_ConfigOutputChannel(BPWM1, 2, 60000, 30);
    BPWM_ConfigOutputChannel(BPWM1, 3, 60000, 40);
    BPWM_ConfigOutputChannel(BPWM1, 4, 60000, 50);
    BPWM_ConfigOutputChannel(BPWM1, 5, 60000, 60);
